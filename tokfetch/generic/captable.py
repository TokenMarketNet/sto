...
from tokfetch.identityprovider import IdentityProvider
from tokfetch.models.tokenscan import _TokenScanStatus
from tokfetch.time import friendly_time
...
class CapTableInfo:
    ...
    def __init__(
            self,
            token_status: _TokenScanStatus,
            last_token_transfer_at,
            total_balance,
            entries
    ):
...
def generate_cap_table(logger: Logger,
    ...
    :param order_by: "balance", "name", "updated", "address"
